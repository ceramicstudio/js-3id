...
import { serveCrossOrigin, serveSameOrigin } from '@ceramicnetwork/rpc-postmessage'
...
describe('3ID Management', () => {
  ...
  //TODO This test fails, if you log the authclient and authserver you can see it returns
  // unfefined to client before server returns response (or appears that way)
